...
def generate_cvrptw_data(cfg, rnds=None,
    ...
    # print(cfg.tw_expansion * cfg.time_factor * epsilon)
    # print(tw)
...
# pyg = gen_pyg_data(cfg, demands, time_window, durations, service_window, time_factor, distances, None)
# print(pyg.time_window)
