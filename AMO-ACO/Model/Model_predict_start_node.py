...
# demands = torch.cat((CVRPTW.capacity.view(-1,), CVRPTW.demand), dim = 0)
...
# distances = gen_distance_matrix(tsp_coordinates, None)
# pyg = gen_pyg_data(demands, time_window, durations, service_window, time_factor, distances, None)

# model = Net().to(device)
# heuristic_measure = model(pyg)
# model2 = Net2().to(device)
# print(heuristic_measure)
# log, topk = model2(pyg, heuristic_measure)
# # print(topk.repeat(2))
