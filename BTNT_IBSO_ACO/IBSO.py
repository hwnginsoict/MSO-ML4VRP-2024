...
def individual(data, colony, CAP):
    colony_1 = Ant(data,CAP,0.8)
...
def IBSO(population, distance, colony, CAP, p = 0.01):
    ...
    cost_team_A_new = []
    for i in team_A:
        travel_distance, route = individual(colony.data, colony, CAP)
